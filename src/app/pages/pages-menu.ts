...
export const MENU_ITEMS: NbMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        link: '/pages/articles/list-articles',
      },
      {
        title: 'Drafts',
    ...
    children: [
      {
        title: 'Add New',
        // icon: 'ion-ios-plus-empty',
        link: '/pages/pages/create-page',
      },
      {
        title: 'All Pages',
        // icon: 'ion-ios-folder-outline',
        link: '/pages/pages/all-pages',
      },
      {
        title: 'Drafts',
        // icon: 'ion-ios-trash-outline',
        link: '/pages/pages/drafts',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: 'All Articles',
        link: '/pages/apperance/index',
      },
      {
        title: 'Trash',
        link: '/pages/apperance/trash',
      },
    ],
  },
  {
